...
int main() {
    ...
    double bs = 39, iva1 = 16, iva2 = 0, bruto = 0, suma = 0;
    double neto1, neto2;
    ...
    do {
        ...
        switch(opcion) {
            ...
            for(int i = 0; i < limite; i++) {
                ...
                bruto = (bruto + vector_precio[i]) * vector_cantidad[i];
            ...
            do { // Edición de los datos.
                ...
                switch(opt_editar) {
                    ...
                    case 5: // Exento.
                    cout << vector_nombre[u] << " pasará a tener la configuración de exento a (Si = 1, No = 0): ";
                    cin >> vector_exento[u];
                    break;
                }
                cout << "\n---------------------------------" << endl;
            ...
            for(int i = 0; i < limite; i++) {
                if(opt_listado == i) {
                    ...
                    cout << "- Exento de IVA: " << (vector_exento[i] ? "Si" : "No") << endl;
            ...
            cout << "- La cantidad total es de " << suma << " productos." << endl;
